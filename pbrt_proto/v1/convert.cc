...
absl::Status ParserV1::Material(
  ...
  static const TypeMap<v1::Material> kSupportedTypes = {
      {"bluepaint",
       CB<RemoveBluePaintMaterial, &Material::mutable_bluepaint>()},
      {"brushedmetal",
       CB<RemoveBrushedMetalMaterial, &Material::mutable_brushedmetal>()},
      {"clay", CB<RemoveClayMaterial, &Material::mutable_clay>()},
      {"felt", CB<RemoveFeltMaterial, &Material::mutable_felt>()},
      ...
      {"primer", CB<RemovePrimerMaterial, &Material::mutable_primer>()},
      {"shinymetal",
       CB<RemoveShinyMetalMaterial, &Material::mutable_shinymetal>()},
      {"skin", CB<RemoveSkinMaterial, &Material::mutable_skin>()},
      {"substrate",
